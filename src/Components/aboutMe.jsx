    ...
    <article className="bg-stone-300 w-full h-auto overflow-hidden flex xs:flex-col md:flex-row">
      ...
      >
        <img
          ...
          alt=""
          className="rounded-full border-8 border-stone-700 p-3 max-w-fit xs:mx-auto xs:my-5"
        />
        <h2
      ...
      <section className="flex xs:flex-col md:w-[75%]">
        <motion.h3 className={aboutsTitle} onClick={() => switchId(1)}
          initial={
            fadeInProperties[0]
          }
          animate={
        ...
        <div 
          className={`${aboutsContainer} ${aboutsAnimation("about me")}`}
        >
        ...
        <motion.h3 className={aboutsTitle} onClick={() => switchId(2)}
          initial={
            fadeInProperties[0]
          }
          animate={
        ...
        <div
          className={`${aboutsContainer} ${aboutsAnimation("about my degrees")}`}
        >
          <p className={aboutsText}>
        ...
        <span className={aboutsSeparator}></span>
        <motion.h3 className={aboutsTitle} onClick={() => switchId(3)}
          initial={
            fadeInProperties[0]
          }
          animate={
