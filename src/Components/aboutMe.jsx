...
// Common CSS styles between childrens
const aboutsContainer = 
    `bg-stone-200 overflow-hidden rounded xs:mx-2 xs:px-2 animate-aboutOpen max-h-fit`;
const aboutsTitle = `flex flex-row justify-between bg-stone-200 text-red-700 
      font-extrabold cursor-pointer rounded-full drop-shadow-lg pl-2 hover:bg-stone-50
      xs:text-[16px] xs:m-2 xs:mx-auto xs:w-[90%] xs:py-2 md:my-4`;
const aboutsText = "xs:text-[14px] xs:py-1";
const aboutsSeparator = "bg-stone-500 xs:mx-auto xs:w-[70%] xs:h-1 md:w-[85%]";
...
export function AboutMe() {
  ...
  return (
    <article
      className="flex bg-stone-300 overflow-hidden xs:flex-col md:flex-row"
    >
      <motion.section
      ...
      >
        <img
          ...
          alt=""
          className="border-stone-700 rounded-full border-8 drop-shadow-md w-[170px] 
            max-w-fit h-[170px] p-3 xs:mx-auto xs:my-5"
        />
        <h2
      ...
      <section className="flex xs:flex-col md:w-[75%]">
        ...
        {toggle === "about me" && <div className={aboutsContainer}>
        ...
        {toggle === "about my degrees" && <div className={aboutsContainer}>
          <p className={aboutsText}>
            I have a bachelor degree in Infrastructure and computer network, and
            one year of computer engineering on the backpack, as well as a bunch
            of trainings and certificates, including:
          </p>
          ...
          <p className={aboutsText}>
            Not to metion all the self taught skills i collected along the way,
            like this react-tailwind web site for example.
          </p>
        </div>}
        <span className={aboutsSeparator}></span>
        <motion.div
        ...
        {toggle === "curiosities" && <div className={aboutsContainer}>
          <ul className={aboutsList}>
